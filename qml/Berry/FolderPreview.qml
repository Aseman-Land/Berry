...
Rectangle {
    ...
    property variant files: path.length==0? new Array : Berry.folderEntry(path,filter,count)
    ...
    onFilesChanged: {
        ...
        var cover_exist = Berry.fileExists(cover_path)
        if( cover_exist )
    ...
    Component{
        ...
        ThumbnailImage {
            ...
            property real singlePadd: 10*Devices.density
        }
    }
