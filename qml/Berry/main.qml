...
AsemanMain {
    ...
    Keys.onPressed: {
        ...
        if( event.key == Qt.Key_C && event.modifiers == Qt.ControlModifier ) {
            ...
            Berry.setCopyClipboardUrl( imageViewer.thumbnailBar.currentPath )
        }
        else
        if( event.key == Qt.Key_X && event.modifiers == Qt.ControlModifier ) {
            ...
            Berry.setCutClipboardUrl( imageViewer.thumbnailBar.currentPath )
        }
        else
        if( event.key == Qt.Key_V ) {
            ...
            Berry.pasteClipboardFiles(imageViewer.thumbnailBar.model.folder)
        }
        else
